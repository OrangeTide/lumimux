...
load_theme_entry(const char *key, const char *value, void *arg)
{
...

	{
		static const struct {
			...
			{ "focus_fg", offsetof(struct tui_theme, focus_fg) },
			{ "focus_bg", offsetof(struct tui_theme, focus_bg) },
			{ "unfocus_fg", offsetof(struct tui_theme, unfocus_fg) },
			{ "unfocus_bg", offsetof(struct tui_theme, unfocus_bg) },
			{ "title_focus_fg", offsetof(struct tui_theme, title_focus_fg) },
			{ "title_idle_fg", offsetof(struct tui_theme, title_idle_fg) },
			{ "close_fg", offsetof(struct tui_theme, close_fg) },
			{ "tool_fg", offsetof(struct tui_theme, tool_fg) },
			{ "status_focus_fg", offsetof(struct tui_theme, status_focus_fg) },
			{ "status_idle_fg", offsetof(struct tui_theme, status_idle_fg) },
			{ "indicator_fg", offsetof(struct tui_theme, indicator_fg) },
			{ "drag_fg", offsetof(struct tui_theme, drag_fg) },
